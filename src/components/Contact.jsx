        ...
        <div className="grid gap-10 lg:grid-cols-2 items-start">
          <div>
            ...
            <div className="mt-6 space-y-3 text-white/80">
              <div className="flex items-center gap-3"><Mail className="h-5 w-5 text-cyan-300" /> your.name@email.com</div>
              <div className="flex items-center gap-3"><Phone className="h-5 w-5 text-cyan-300" /> +1 (555) 123-4567</div>
            </div>
          </div>
